...
- Class to represent your linked list. It contains the start, head of you linked list.
- Class that represents the Node of your linked list. Which contains the data and and the next pointer information.


1. Create a class to represent your linked list, you need this class to store the the start, head, of your linked list;
